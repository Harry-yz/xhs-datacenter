...
class Settings:
    ...
    huitun_limit_guard_window_minutes: int = int(os.getenv("HUITUN_LIMIT_GUARD_WINDOW_MINUTES", "20"))
    huitun_limit_guard_threshold: int = int(os.getenv("HUITUN_LIMIT_GUARD_THRESHOLD", "60"))
    ...
    search_stale_minutes: int = int(os.getenv("SEARCH_STALE_MINUTES", "30"))
    ...
    search_pending_poll_ms: int = int(os.getenv("SEARCH_PENDING_POLL_MS", "2000"))
    search_result_cache_ttl_seconds: int = int(os.getenv("SEARCH_RESULT_CACHE_TTL_SECONDS", "600"))
    search_db_first_timeout_ms: int = int(os.getenv("SEARCH_DB_FIRST_TIMEOUT_MS", "5000"))
    search_v2_enabled: bool = _get_bool("SEARCH_V2_ENABLED", True)
    search_v2_dual_read: bool = _get_bool("SEARCH_V2_DUAL_READ", False)
    search_v2_fallback_on_error: bool = _get_bool("SEARCH_V2_FALLBACK_ON_ERROR", True)
    search_v2_recall_guard_enabled: bool = _get_bool("SEARCH_V2_RECALL_GUARD_ENABLED", True)
    search_v2_recall_guard_min_total: int = int(os.getenv("SEARCH_V2_RECALL_GUARD_MIN_TOTAL", "20"))
    search_v2_recall_guard_delta: int = int(os.getenv("SEARCH_V2_RECALL_GUARD_DELTA", "5"))
    search_auto_poll_enabled: bool = _get_bool("SEARCH_AUTO_POLL_ENABLED", True)
    search_v2_candidate_limit: int = int(os.getenv("SEARCH_V2_CANDIDATE_LIMIT", "5000"))
    search_v2_note_candidate_limit: int = int(os.getenv("SEARCH_V2_NOTE_CANDIDATE_LIMIT", "8000"))
    search_incremental_batch_size: int = int(os.getenv("SEARCH_INCREMENTAL_BATCH_SIZE", "3000"))
    search_incremental_refresh_interval_seconds: int = int(
        os.getenv("SEARCH_INCREMENTAL_REFRESH_INTERVAL_SECONDS", "60")
    )
    search_incremental_worker_timeout_ms: int = int(os.getenv("SEARCH_INCREMENTAL_WORKER_TIMEOUT_MS", "12000"))
    search_incremental_backlog_warn_threshold: int = int(os.getenv("SEARCH_INCREMENTAL_BACKLOG_WARN_THRESHOLD", "10000"))
    search_running_recover_interval_seconds: int = int(os.getenv("SEARCH_RUNNING_RECOVER_INTERVAL_SECONDS", "300"))
    search_incremental_author_window_days: int = int(os.getenv("SEARCH_INCREMENTAL_AUTHOR_WINDOW_DAYS", "30"))
